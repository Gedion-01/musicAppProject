  ...
  return (
    <Flex flexDirection={"column"}>
      <Flex flexDirection={"row"} css={genreStyles.styles} mt={2}>
        <Link to={"Ethiopian"} style={{textDecoration: "none", color: "#1f3044"}}>
          <Genre name={"Ethiopian"} imgUrl={"https://th.bing.com/th/id/OIP.gQTSRBvwGnns-qDT8v1AUgAAAA?rs=1&pid=ImgDetMain"} />
        </Link>
        <Link to={"Electronic"} style={{textDecoration: "none", color: "#1f3044"}}>
        ...
        <Link to={"Hip-Hop"} style={{textDecoration: "none", color: "#1f3044"}}>
        ...
        <Link to={"Workout"} style={{textDecoration: "none", color: "#1f3044"}}>
